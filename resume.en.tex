...
\\[0.25cm]
\uddannelse{Visiting Member}{1999}{Courant Institute of Mathematical Sciences, New York University. Mathematics of Finance. Host Marco Avellaneda. Recipient of Andersens Scholarship for Mathematicians}
\\[0.25cm]
...
%===============================================================================
\section{Skills}
\kompetence{Programming Languages \\ and frameworks}{Production experience with: Python, C\#, .NET Framework and Core, WPF, WCF, LINQ, ASP.NET Core, C\(++\), STL, Boost and C. Knowledge of R, JavaScript, F\#, and Scala}
\\[0.2cm]
