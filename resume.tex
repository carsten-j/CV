...
\opgave{integration til ny betalingsløsning}
}
...
%===============================================================================
\section{Kompetencer}
\kompetence{Programmeringssprog \\ og frameworks}{Produktionserfaring med: Python, C\#, .NET Framework og Core, WPF, WCF, LINQ, ASP.NET Core, C\(++\), STL, Boost og C. Derudover kendskab til F\#, Scala og R}
\\[0.2cm]
