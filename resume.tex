...
\setmainfont[Ligatures=TeX]{Apercu Light}
\setmonofont{Apercu Mono}
...
\begin{Row}%
  ...
  \begin{Cell}{3}
    ...
    $\greysquare$ full-stack udvikling af post trade services til både internt brug og eksterne kunder \\
...
\begin{Row}
  ...
  \end{Cell}
  \begin{Cell}{3}
    Som softwareudvikler og arkitekt var det min opgave at udvikle software baseret på forsikringsmatematiske principper og \\ [1ex]
...
\begin{Row}%
  ...
  \end{Cell}
  \begin{Cell}{3}
    Produktionserfaring med: C\#, .NET, WCP, WPF, LINQ, Rx, SQL, C++, STL, Boost % chktex 26,
    og C Derudover: kendskab til F\#, Scala, Python, Java, JavaScript, R og MongoDB
  \end{Cell}
\end{Row}
\\[0.5cm]
\begin{Row}%
