...
22+ års erfaring med professionel software udvikling af large scale systemer primært til den finansielle sektor. Erfaring med matematisk modellering
...
markets (11 år) samt ERP systemer (5 år). Mit kendetegn er levering til tiden
...
\\[0.5cm]\begin{Row}%
  \begin{Cell}{1}
    ...
    Jan 2014 -- Maj 2014 % chktex 8
  \end{Cell}
  \begin{Cell}{3}
    Frivilling i lektiecafe på Vesterbros Bibliotek, hvor jeg hjalp folkeskoleelever med deres ma\-te\-ma\-tik opgaver.
  \end{Cell}
\end{Row}
