...
%===============================================================================
\section{Kompetencer}
\kompetence{Programmingssprog \\ og frameworks}{Produktionserfaring med: Python, C\#, .NET Framework og Core, WPF, WCF, LINQ, ASP.NET, C\(++\), STL, Boost og C. Derudover kendskab til F\#, Scala og R}
\\[0.2cm]
\kompetence{Data systemer}{SQL Server, MongoDB, Redis, RabbitMQ og Kafka}
\\[0.2cm]
\kompetence{DevOps tools}{Docker, ELK, InfluxDB, Grafana, GoCD, Git, Mercurial, TFS, Icinga2, VictorOps}
